...
class MainWindow:
    ...
    def create_display_frame(self, parent):
        ...
        self.burn_file_label = tk.Label(self.burn_file_frame, text="烧录文件: [未选择]")
        ...
        self.partition_file_label = tk.Label(self.partition_file_frame, text="分区文件: [未选择]")
        ...
        self.burn2_file_label = tk.Label(self.burn2_file_frame, text="烧录文件2: [未选择]")
        ...
        self.partition2_file_label = tk.Label(self.partition2_file_frame, text="分区文件2: [未选择]")
        ...
        self.upgrade_file_label = tk.Label(self.upgrade_file_frame, text="升级文件: [未选择]")
        ...
        self.bob_test_file_label = tk.Label(self.bob_test_file_frame, text="BOB测试文件: [未选择]")
        ...
        self.bob_debug_file_label = tk.Label(self.bob_debug_file_frame, text="BOB调试文件: [未选择]")
        ...
        self.bob_test2_file_label = tk.Label(self.bob_test2_file_frame, text="BOB测试文件2: [未选择]")
        ...
        self.bob_debug2_file_label = tk.Label(self.bob_debug2_file_frame, text="BOB调试文件2: [未选择]")
        ...
        self.optical_file_label = tk.Label(self.optical_file_frame, text="光调测文件: [未选择]")
        ...
        self.export_data_file_label = tk.Label(inner_frame, text="出库数据文件: [未选择]")
        ...
        self.reserve3_file_label = tk.Label(self.reserve3_file_frame, text="预留文件3: [未选择]")
